...
>
  ...
  <Box flex={1} minWidth={240}>
    ...
    <Typography variant="body1" sx={{ color: theme.palette.text.secondary, mb: 0.5 }}>
      <CallIcon sx={{ fontSize: '24px', transform: 'translateY(5px)', mr: 1, color: '#2196f3' }} />
      {profile.phone || '—'}
    </Typography>

    <Typography variant="body1" sx={{ color: theme.palette.text.secondary }}>
      <HomeIcon sx={{ fontSize: '24px', transform: 'translateY(5px)', mr: 1, color: '#2196f3' }} />
      {profile.address || '—'}
    </Typography>
    ...
    <Box mt={3}>
      ...
      <Divider sx={{ mb: 3 }} />
      <Typography variant="h6" sx={{color:'#1e88e5'}} mb={2}><ShoppingCartIcon sx={{fontSize:'20px',transform: 'translateY(5px)'}}></ShoppingCartIcon> {t('products')} {profile.full_name}:</Typography>

      {products.length === 0 ? (
        <Typography color="text.secondary"> {t('Therearenoproductsforthisuser')}</Typography>
      ) : (
...
>
  {/* ✅ زر السلة في زاوية الكارت حسب اللغة */}
  <IconButton
    onClick={(e) => {
      e.stopPropagation()
      handleAddToCart(p)
  ...
  >
    <ShoppingCartIcon sx={{ color: addedToCartIds.includes(p.id) ? 'green' : '#1976d2' }} />
  </IconButton>
  ...
  <Box
    ...
    sx={{
      ...
      filter: theme.palette.mode === 'dark' ? 'brightness(0.9)' : 'brightness(0.98)',
      '&:hover': {
        transform: 'scale(1.03)',
        filter: theme.palette.mode === 'dark' ? 'brightness(1.05)' : 'brightness(1.05)'
      }
    }}
  />
      ...
      {selectedProduct && (
        <>
         ...
         ...(i18n.language === 'ar' ? { left: 12 } : { right: 12 }),
          ...
          {/* Sidebar Drawer للشاشات الصغيرة */}
          <Drawer
          ...
          <Box
            sx={{
              ...
              borderLeft: isArabic ? undefined : `1px solid ${theme.palette.divider}`,
              borderRight: isArabic ? `1px solid ${theme.palette.divider}` : undefined,
              boxShadow: isArabic
          ...
          >
            <Box px={{ xs: 2, md: 4 }} py={{ xs: 2, md: 4 }}>
              ...
              <Typography
                variant="h5"
                fontWeight="bold"
                sx={{ color: theme.palette.text.primary, mb: 1, textAlign: isArabic ? 'right' : 'left' }}
              >
              ...
              <Typography
                ...
                fontWeight="bold"
                mb={2}
                sx={{ color: theme.palette.text.primary, textAlign: isArabic ? 'right' : 'left' }}
              >
                <MessageIcon sx={{ transform: 'translateY(5px)', mr: 1, ml: 1 }} />
                {t('Comments')}
              </Typography>

              {comments.length === 0 ? (
                <Typography color="text.secondary" sx={{ textAlign: isArabic ? 'right' : 'left' }}>
                  ...
                  {comments.map(c => (
                    ...
                    >
                      ...
                      >
                        ...
                        <Box flex={1}>
                          <Typography variant="body1" fontWeight="bold" sx={{ color: theme.palette.text.primary, textAlign: isArabic ? 'right' : 'left' }}>
                            {c.profiles?.full_name || '—'}
                          </Typography>
                          <Typography variant="body2" sx={{ color: theme.palette.text.secondary, mt: 0.5, textAlign: isArabic ? 'right' : 'left' }}>
                            {c.content}
                          </Typography>
                          <Typography variant="caption" sx={{ color: theme.palette.text.disabled, mt: 0.5, display: 'block', textAlign: isArabic ? 'right' : 'left' }}>
          ...
          <Box
            sx={{
              px: { xs: 2, md: 4 },
              py: { xs: 2, md: 3 },
              bgcolor: theme.palette.mode === 'dark' ? '#444444ff' : '#f5f5f5',
          ...
          >
            <Box display="flex" flexDirection={{ xs: 'row', sm: 'row' }} gap={1}>
              <TextField
                fullWidth
                multiline
                rows={1}
                ...
                sx={{
                  bgcolor: theme.palette.mode === 'dark' ? '#494949ff' : '#f5f5f5',
                  borderRadius: 3,
                  '& .MuiInputBase-root': {
                    borderRadius: 3,
                    boxShadow:
                  ...
                  '& .MuiInputBase-input': { fontSize: 14, direction: isArabic ? 'rtl' : 'ltr' },
              ...
              <Button
                variant="contained"
                color="primary"
                sx={{ borderRadius: 3, height: 'fit-content', whiteSpace: 'nowrap' }}
